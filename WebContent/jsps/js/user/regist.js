$(function() {
	...
	$("#submitBtn").hover(
		function() {
			$("#submitBtn").attr("src", "/photography/images/regist2.jpg");
		},
		function() {
			$("#submitBtn").attr("src", "/photography/images/regist1.jpg");
		}
	);
...
function validateEmail() {
	 ...
	 */
	$.ajax({
		url:"/photography/ajaxValidateEmail",//要请求的servlet
...
function _hyz() {
	 ...
	 * 3. 使用毫秒来添加参数
	 */
	$("#imgVerifyCode").attr("src", "/photography/verifyCode?a=" + new Date().getTime());
}
