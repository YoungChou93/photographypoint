...
<form action="<c:url value='/register'/>" method="post" id="registForm" target="_self">
    ...
    <table id="tableForm">
      <tr>
        ...
        <td>
          <input class="inputClass" type="text" name="user.email" id="email"  maxlength="40"/>
        </td>
        <td>
       ...
       <tr>
        ...
        <td>
          <input class="inputClass" type="text" name="user.nickname" id="loginname"  maxlength="20"/>
        </td>
        <td>
      ...
      <tr>
        ...
        <td>
          <input class="inputClass" type="password" name="user.password" id="loginpass"  maxlength="16"/>
        </td>
        <td>
      ...
      <tr>
        ...
        <td>
          <input class="inputClass" type="password" name="reloginpass" id="reloginpass"  maxlength="16"/>
        </td>
        <td>
